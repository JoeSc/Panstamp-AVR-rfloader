...
{
//NOLD  // Disable LNA on LD-board if any
//NOLD  if (hgmEnabled)
//NOLD    disableLNA();
...
//NOLD  // Enable LNA on LD-board if any
//NOLD  if (hgmEnabled)
//NOLD    enableLNA();
}
...
{
//NOLD  // Enable PA on LD-board if any
//NOLD  if (hgmEnabled)
//NOLD    enablePA();
...
//NOLD  */
//NOLD void CC1101::enablePA(void)
//NOLD {
//NOLD  digitalWrite(PA_EN, HIGH);
//NOLD  digitalWrite(LNA_EN, LOW);
//NOLD }
//NOLD 
//NOLD /**
//NOLD  * enableLNA
...
//NOLD  */
//NOLD void CC1101::enableLNA(void)
//NOLD {
//NOLD  digitalWrite(LNA_EN, HIGH);
//NOLD  digitalWrite(PA_EN, LOW);
//NOLD }
//NOLD 
//NOLD /**
//NOLD  * disableLNA
...
//NOLD  */
//NOLD void CC1101::disableLNA(void)
//NOLD {
//NOLD  digitalWrite(LNA_EN, LOW);
//NOLD  digitalWrite(PA_EN, LOW);
//NOLD }
...
//NOLD  * enableHGM
//NOLD  *
//NOLD  * Enable Long-distance board with CC1190 IC in high-gain mode
//NOLD  */
//NOLD void CC1101::enableHGM(void)
//NOLD {
//NOLD  hgmEnabled = true;
//NOLD 
//NOLD  pinMode(HGM, OUTPUT);
//NOLD  pinMode(LNA_EN, OUTPUT);
//NOLD  pinMode(PA_EN, OUTPUT);
//NOLD 
//NOLD  digitalWrite(HGM, HIGH);
//NOLD }
//NOLD 
//NOLD /**
//NOLD  * disableHGM
//NOLD  *
//NOLD  * Disable high-gain mode on the LD-Board
//NOLD  */
//NOLD void CC1101::disableHGM(void)
//NOLD {
//NOLD  hgmEnabled = false;
//NOLD 
//NOLD  digitalWrite(HGM, LOW);
//NOLD }
